...
def create_run_eval_bash(bash_save_dir, results_save_dir, route_path, route, checkpoint, logs_save_dir,
                         carla_tm_port_start, benchmark, tracking, path_to_planning, carla_root, only_vehicle_bb=0):
...
export TEAM_AGENT=team_code/map_agent_plant.py
...
def main():
  num_repetitions = 3
  experiment = '000_MAP_PP_downloaded' 
  ...
  path_to_planning_downloaded = '/mnt/qb/work/geiger/gwb710/carla_garage/pretrained_models/longest6/plant_all_1'

  model_dict = {
    "lav": {
        "path_to_planning":{
          1:"/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/plant_v08_only_vehicle_lav",
          0:"/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/plant_v08_default_lav"
        },
        "model_dir":'/mnt/qb/work/geiger/gwb710/carla_garage/pretrained_models/lav/tfpp_02_05_withheld_0/',
    },
    "longest6": {
        "path_to_planning":{
          1:"/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/plant_v08_only_vehicle",
          0:"/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/plant_v08_default"
        },
        "model_dir":'/mnt/qb/work/geiger/gwb710/carla_garage/pretrained_models/longest6/tfpp_all_0',
    }
  }
  ...
  username = 'gwb710'
  epochs = ['model_0030']
  benchmarks = ["longest6", "lav"] # ["lav"]
  tracking_grid = [1,0]
  only_vehicle_grid = [1,0]
  ...
  total_num_evals_runs = len(benchmarks) * len(tracking_grid) * len(only_vehicle_grid)
  ...
  for benchmark in benchmarks:
    path_to_planning_dict = model_dict[benchmark]["path_to_planning"]
    model_dir = model_dict[benchmark]["model_dir"]
    for tracking in tracking_grid:
      for only_vehicle_bb in only_vehicle_grid:
        
        path_to_planning = path_to_planning_dict[only_vehicle_bb]
        path_to_planning = path_to_planning_downloaded
        print("CAREFUL! OVERWRITING WITH DOWNLOADED VERSION!!")
        print(path_to_planning)
  ...
  for benchmark in benchmarks:
    for tracking in tracking_grid:
      for only_vehicle_bb in only_vehicly_grid:
        for epoch in epochs:
          experiment = raw_experiment
          if tracking:
            experiment += "_TRACKING"
