...
def create_run_eval_bash(bash_save_dir, results_save_dir, route_path, route, checkpoint, logs_save_dir,
                         carla_tm_port_start, benchmark, tracking, tf_det_th, second_det_th, half,
                         path_to_planning, carla_root, pcd_cfg, pcd_ckpt):
...
export TEAM_AGENT=team_code/map_agent_plant_second.py
...
export TP_STATS=0
export ONLY_VEHICLE_BB=1
export HALF_EXTENTS={half}
export BENCHMARK={benchmark}
export TRACKING={tracking}
export DET_TH={tf_det_th}
export PCD_DETECTION_THRESHOLD={second_det_th}
export PATH_TO_PLANNING_FILE={path_to_planning}
export PCD_CFG_PATH={pcd_cfg}
export PCD_CKPT_PATH={pcd_ckpt}
""")
    rsh.write('''
...
def main():
  # export LD_LIBRARY_PATH='/mnt/qb/work/geiger/gwb710/software/anaconda3/lib'
  num_repetitions = 3
  experiment = '11_27_FIX_SECOND_PLANT'
  partition = 'gpu-2080ti'# -preemptable  '
  
  benchmarks = ["lav"] # , "longest6"] 
  tracking_grid = [1] # [1,0]
  tf_det_th_grid = [0.4]
  second_det_th_grid = [0.2, 0.3, 0.4, 0.1]
  half_grid = [1,0]
  ...
  pcd_cfg = '/mnt/qb/work/geiger/gwb710/OpenPCDet/tools/cfgs/custom_models/second_new.yaml'
  pcd_ckpt = '/mnt/qb/work/geiger/gwb710/OpenPCDet/output/custom_models/second_new/TMP_TEST_subsampled_data/LR_0.003/WEIGHT_DECAY_0.001/GRAD_NORM_CLIP_10/ckpt/checkpoint_epoch_80.pth'

  # L6 TF
  # model_dir = '/mnt/qb/work/geiger/gwb710/carla_garage/pretrained_models/longest6/tfpp_all_0'
  # LAV TF
  # model_dir = '/mnt/qb/work/geiger/gwb710/carla_garage/pretrained_models/lav/tfpp_02_05_withheld_0/'
  model_dict = {
    "lav": {
        "path_to_planning":"/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/plant_v08_only_vehicle_lav",
#        "model_dir_plant":"/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/plant_v08_default_lav",
        "model_dir":'/mnt/qb/work/geiger/gwb710/carla_garage/pretrained_models/lav/tfpp_02_05_withheld_0/',
    },
    "longest6": {
        "path_to_planning":"/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/plant_v08_only_vehicle",
#        "model_dir_plant":"/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/plant_v08_default",
  ...
  total_num_evals_runs = len(tracking_grid) * len(tf_det_th_grid) * len(second_det_th_grid) * len(half_grid)
  total_num_evaluations = int(benchmark_length * (total_num_evals_runs))
  num_evaluations = 0
  num_eval_runs = 0
  ...
  for benchmark in benchmarks:
    path_to_planning = model_dict[benchmark]["path_to_planning"]
    model_dir = model_dict[benchmark]["model_dir"]
    
    for tf_det_th in tf_det_th_grid:
      for second_det_th in second_det_th_grid:
        for half in half_grid:
          for tracking in tracking_grid:
            ...
            if half:
              experiment += "_HALF_EXTENT"
            if len(tf_det_th_grid) > 1:
              experiment += f"_tf_th_{tf_det_th}"
            experiment += f"_det_th_{second_det_th}"
              ...
              for exp_name in exp_names:
                for route in route_files:
                  ...
                  create_run_eval_bash(bash_save_dir,
                                      ...
                                      tracking=tracking,
                                      tf_det_th=tf_det_th,
                                      second_det_th=second_det_th,
                                      half=half,
                                      path_to_planning=path_to_planning,
