#!/bin/bash
#SBATCH --job-name=plant_v08_only_vehicle_lav
#SBATCH --ntasks=1 
...
#SBATCH --gres=gpu:8 
#SBATCH --mem=256G 
#SBATCH --output=/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/slurm/plant_v08_only_vehicle_lav.out 
#SBATCH --error=/mnt/qb/work/geiger/gwb710/carla_garage/training_logdir/slurm/plant_v08_only_vehicle_lav.err 
...
train.py --id plant_v08_only_vehicle_lav --batch_size 64 --setting 02_05_withheld \
